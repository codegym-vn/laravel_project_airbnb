...
<div id="wrapper">
    <div class="main">
            ...
            <div class="border-gray-100 bg-gray-20 radius" style="width: 300px">
                ...
                <div class="pd-left-10 pd-right-10">
                    ...
                    <ul class="list-info clearfix">
                        <li>
                            <div class="value">
                                Phòng ngủ:   {{ $seeDetailHouses->number_room }}
                            </div>

                        </li>
                        <li>
                            <div class="value">
                                Phòng tắm:  {{ $seeDetailHouses->number_bathroom }}
                            </div>
        ...
        <div class="mg-bottom-10 clearfix">
            <h4 class="pull-left lh-24 fsize-16 text-uppercase dblue-clr border-bottom-gray-100 no-mg "
                style="padding-top:15px ">Thông tin
                chi tiết</h4>
        </div>
        ...
        <div class="mg-bottom-20">
            <div id="maps" class="spanMap box">
                ...
                <input type="hidden" name="ctl00$MainContent$ProductDetail1$hddLongtitude" id="hddLongtitude"
                       value="105.85244722590335"/>
                <input type="hidden" name="ctl00$MainContent$ProductDetail1$txtPositionX" id="txtPositionX"
                       value="14.058324"/>
                <input type="hidden" name="ctl00$MainContent$ProductDetail1$txtPositionY" id="txtPositionY"
                       value="108.277199"/>
                <input type="hidden" name="ctl00$MainContent$ProductDetail1$hddDiadiem" id="hddDiadiem"
                       value="Dự án King Bay, đường Vành Đai 3, xã Long Tân, Nhơn Trạch, Đồng Nai"/>


                <script type="text/javascript"
                        src="https://maps.google.com/maps/api/js?key=AIzaSyC77CvzkEizyKrWpzADJRuZFhm-ZklyNwk"></script>

                <script src="/Scripts/GoogleMapControl.js"></script>
                <style>
                    #maps #mapinfo {
